...
<article class="sklo-page sklo-legal-page">
  <div class="sklo-wrap sklo-page__inner">
    ...
    <div class="sklo-prose">
      ...
      <h2>Montáž</h2>
      <p>Termín montáže závisí na kalendáři techniků a lokalitě. Domlouváme individuálně po výrobě (nebo souběžně, pokud to dává smysl). V Praze a vzdálenějších regionech často plánujeme společné výjezdy — viz <a href="<?php echo esc_url($doprava); ?>#praha">doprava</a>. Orientační ceny montáže: <a href="<?php echo esc_url($doprava); ?>#montaz">doprava a montáž</a>. Montáž se typicky hradí na místě po podpisu předávacího protokolu.</p>
